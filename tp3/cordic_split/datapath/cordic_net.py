...
class Cordic_Net ( Model ):
    ...
    def Netlist ( self ):
        ...
        i                       = Signal('i'                        , 3 )
        cmd_n_0	                = Signal('cmd__n_0'                 , 1 )
        cmd_n_1_1	            = Signal('cmd__n_1_1'               , 1 )
        cmd_n_1_0               = Signal('cmd__n_1_0'               , 1 )
        cmd_n                   = Signal('cmd__n'                   , 1 )
        cmd_adder_pm_xkc        = Signal('cmd__adder_pm_xkc'        , 1 )
        cmd_adder_pm_ykc        = Signal('cmd__adder_pm_ykc'        , 1 )
        cmd_post0_adder_1       = Signal('cmd__post0_adder_1'       , 1 )
        cmd_post0_adder	        = Signal('cmd__post0_adder'         , 1 )
        cmd_post0_adder_0	    = Signal('cmd__post0_adder_0'       , 1 )
        cmd_post1_adder         = Signal('cmd__post1_adder'         , 1 )
        cmd_adder_x_pm_y_sra_i  = Signal('cmd__adder_x_pm_y_sra_i'  , 1 )
        cmd_adder_y_pm_x_sra_i  = Signal('cmd__adder_y_pm_x_sra_i'  , 1 )
        ...
        self.instances['ctl'] = Inst( 'cordic_ctl', 'ctl'
                                    , map = { 'ck'         : self.ck
                                            ...
                                            , 'cmd_n_1_0'	            : cmd_n_1_0
                                            , 'cmd_n'	                : cmd_n
                                            , 'cmd_adder_pm_xkc'        : cmd_adder_pm_xkc
                                            , 'cmd_adder_pm_ykc'        : cmd_adder_pm_ykc
