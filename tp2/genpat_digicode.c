...
main ()
{
	...
	AFFECT	("0",			"ck",		"0b1");
	AFFECT	("0",			"jour",		"0b0");
	AFFECT	("0",			"press_kbd",	"0b0");
	AFFECT	("0",			"O",		"0b0");
	AFFECT	("0",			"timer5_tm",	"0b0");
	AFFECT	("0",			"timer120_tm",	"0b0");
	AFFECT	("0",			"i",		"0b0000");
	//out
	AFFECT	("0",			"timer5_en",	"0B*");
	AFFECT	("0",			"timer120_en",	"0B*");
	AFFECT	("0",			"alarm",	"0B*");
	AFFECT	("0",			"porte",	"0B*");

	

	for (cur_vect = 0; cur_vect < 26; cur_vect++)
	{
		if (cur_vect == 1){
			AFFECT  (inttostr(2*pas*cur_vect), "reset", "0b0");
			AFFECT	(inttostr(2*pas*cur_vect), "timer5_en", "0B0");
			AFFECT	(inttostr(2*pas*cur_vect), "timer120_en", "0B0");
			AFFECT	(inttostr(2*pas*cur_vect), "alarm", "0B0");
